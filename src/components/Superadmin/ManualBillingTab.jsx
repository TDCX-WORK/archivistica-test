          ...
          <div className={styles.rowGrid}>
            ...
            <div className={styles.rowCol}>
              ...
              <div className={styles.rowField}>
                <span className={styles.rowFieldLabel}>Base imponible</span>
                <span className={styles.rowFieldVal}>€{fmt(inv.base_amount || 0)}</span>
              </div>
              <div className={styles.rowField}>
                <span className={styles.rowFieldLabel}>IVA ({inv.vat_rate || 21}%)</span>
                <span className={styles.rowFieldVal}>€{fmt(inv.vat_amount || 0)}</span>
              </div>
            ...
            <div className={styles.rowCol}>
              ...
              {inv.paid_at && (
                <div className={styles.rowField}>
                  <span className={styles.rowFieldLabel}>Pagada el</span>
                  <span className={styles.rowFieldVal}>{fmtDate(inv.paid_at)}</span>
                </div>
              )}
              {inv.cancels_invoice && (
                <div className={styles.rowField}>
                  <span className={styles.rowFieldLabel}>Rectifica</span>
        ...
        <div className={styles.modalBody}>
          <div className={styles.field}>
            ...
            <select className={styles.select} value={form.academy_id}
              onChange={e => {
                ...
                if (ac?.price_monthly) set('base_amount', ac.price_monthly)
              }}>
              <option value=''>Seleccionar academia…</option>
              {academias.filter(a => !a.deleted_at).map(a => (
          ...
          <div className={styles.fieldRow}>
            <div className={styles.field}>
              ...
              <select className={styles.select} value={form.payment_method}
        ...
        <div className={styles.filters}>
          ...
          <div className={styles.filterTabs}>
            {[
              ...
              <button key={f.id}
                className={[styles.filterTab, filterSt === f.id ? styles.filterTabActive : ''].join(' ')}
                onClick={() => setFilterSt(f.id)}>
                {f.label}
